...
<!DOCTYPE html>
    ...
    <!--?php include('Nav.php')?>
		...
		<legend ><font face = "cambria" size = 10 color = "grey"> Certificate of Indigency </font></legend><br>
		...
		<!--div class="panel-group" -->
			...
			<br>
			<div class="panel panel-primary">
				<div class="panel-heading"><font face="cambria" size=5 color="white"><center><b>CERTIFICATE OF INDIGENCY</b></center></font></div>
					<div class="panel-body">						
						<div class="col-sm-12">
							<p><font face="cambria" size=5 color="grey"> Request for: </font></p>
								<input id="DRdocreqID" class="form-control input-group-lg reg_name" type="text" name="DRdocReqfor" title="system-generated">
								<?php /*echo "<select class='form-control' id='DRpurpose' name='DRRequestedBy'>";
							...
							<input type="submit" class="btn btn-success btn-lg btn-block" name = "btnSubmitU" id = "btnSubmitU" value = "Submit">
						</form>
						</div>
					</div>
				</div>
		...
		<?php
			...
			if(isset($_POST['btnSubmitU']))
			{
				$docReqID = $_POST['DRdocreqID'];
				$docReqfor = $_POST['DRdocReqfor'];
