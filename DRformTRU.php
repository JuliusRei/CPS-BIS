...
h                                    </div>
    ...
    <!--?php include('Nav.php')?>
		...
		<legend ><font face = "cambria" size = 10 color = "grey"> Tricycle Regulatory Unit (TRU) </font></legend><br>
					...
					<div class="panel-body">
						...
						<div class = "form-group">
							<div class="checkbox">
								...
								<font face="cambria" size=5 color="black">Certification from TODA Evaluation/Assessment</label>
							</div>
							<div class="checkbox">
								<label><input type="checkbox" value="">
				...
				<div class="panel-heading"><font face="cambria" size=5 color="white"><center><b>VEHICLE DETAILS</b></center></font></div>
					<div class="panel-body">
						...
						<div class="col-sm-12">
							...
							<input id="toda" class="form-control input-group-lg reg_name" type="text" name="toda" title="system-generated">
						</div>
						<div class="col-sm-4">
