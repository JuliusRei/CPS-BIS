        ...
        <div id="page-content-wrapper">
			...
			<div class="form-group">
				<div class="col-sm-5">
					...
					<input type="text" id="datetimepicker2" class="form-control input-group-lg reg_name, some_class" value="<?php if(isset($_POST['resId'])){echo $_POST['From'];}else{}?>" name = "From"/>					
					<p><font face="cambria" size=4 color="grey"> To </font></p>
					<input type="text" id="datetimepicker2" class="form-control input-group-lg reg_name, some_class" value="<?php if(isset($_POST['resId'])){echo $_POST['To'];}else{}?>" name = "To"/>
				</div><br><br><br><br><br>
						...
						if(isset($_POST['btnSubmit'])){
							...
							if(!empty($resFacility) || !empty($equipment) && !empty($resfrom) && !empty($resto)){
								...
								if(!empty($resFacility)){
									...
									$query = mysqli_query($con, "select dblfacifixedchargeperhour, dblfacidaychargeperhour, dblfacinightchargeperhour, strfacicontrolno from tblFacility where strFaciName = '$resFacility'");
