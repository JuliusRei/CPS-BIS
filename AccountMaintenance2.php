...
<br>
					...
					$s = $_SESSION['s'] ;
				$sql = "SELECT `strOfficerID`,`strUsername`,`strPassword`, concat(strOfficerLname,',',strOfficerFname,' ',strOfficerMname) as 'Name', `datOfficerBirthdate` FROM `tblaccount` where concat(strOfficerLname,',',strOfficerFname,' ',strOfficerMname)  LIKE '%$s%' ";
